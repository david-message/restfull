...
public abstract class UriBuilder {
    ...
    /**
     * Set the URI scheme-specific-part (see {@link URI}). This
     ...
     * {@link #buildFromMap(Map, boolean) buildFromMap(valueMap, true)}.
     ...
     * @see #buildFromMap(Map, boolean)
     * @see #buildFromEncodedMap(Map)
     */
     ...
     * the {@link #buildFromMap(Map)} method. If the {@code encodeSlashInPath}
