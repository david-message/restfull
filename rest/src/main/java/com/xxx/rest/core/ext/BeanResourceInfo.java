...
public abstract class BeanResourceInfo extends AbstractResourceInfo {
    ...
    protected BeanResourceInfo(Class<?> resourceClass, Class<?> serviceClass, boolean isRoot) {
        this(resourceClass, serviceClass, isRoot, true);
    }
    
    protected BeanResourceInfo(Class<?> resourceClass, Class<?> serviceClass, 
                               boolean isRoot, boolean checkContexts) {
        super(resourceClass, serviceClass, isRoot, checkContexts);
