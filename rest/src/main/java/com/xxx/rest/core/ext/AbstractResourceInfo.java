...
import com.xxx.rest.core.Context;
import com.xxx.rest.core.HttpHeaders;
import com.xxx.rest.core.ext.tl.ThreadLocalProxy;
...
//        STANDARD_CONTEXT_CLASSES.add(ContextResolver.class.getName());
    ...
    protected AbstractResourceInfo(Class<?> resourceClass, Class<?> serviceClass,
                                   boolean isRoot, boolean checkContexts) {
        this(resourceClass, serviceClass, isRoot, checkContexts, null, null);
    }
