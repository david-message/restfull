...
package com.xxx.rest.core;

import com.xxx.rest.core.ext.RuntimeDelegate;
 ...
 * convenient methods to create such values as does {@link URI#create(String)}.
 * </p>
 *
 * @author Paul Sandoz
 * @author Marc Hadley
...
public abstract class Response implements AutoCloseable {
     ...
     * type is an {@link InputStream input stream}, this method automatically
     ...
     * {@link javax.ws.rs.ext.RuntimeDelegate#createHeaderDelegate(Class)} for the
     ...
     * via {@link javax.ws.rs.ext.RuntimeDelegate#createHeaderDelegate(Class)}
    ...
    public static abstract class ResponseBuilder {
         ...
         *                {@link #header(String, Object)} method.
         * @return the updated response builder.
         */
