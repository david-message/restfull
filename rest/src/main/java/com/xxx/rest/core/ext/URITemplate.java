...
import com.xxx.rest.utils.HttpUtils;
...
public final class URITemplate {
    ...
    public URITemplate(String theTemplate) {
        ...
        while (tok.hasNext()) {
            ...
            uriChunks.add(chunk);
            if (chunk instanceof Literal) {//文本
            ...
            } else if (chunk instanceof Variable) {//变量
                Variable var = (Variable) chunk;
                variables.add(var.getName());
                if (var.getPattern() != null) {//正则表达式
...
//            sb.append(isReservedCharacter(ch) ? "\\" + ch : ch);
    ...
    private abstract static class UriChunk {
        ...
        public static UriChunk createUriChunk(String uriChunk) {
            if (uriChunk == null || uriChunk.isEmpty()) {
